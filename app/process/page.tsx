  ...
  const t = {
    de: {
      ...
      steps: [
        ...
        { title: 'Design-Entwurf', desc: 'Ich erstelle dir einen ersten Design-Entwurf (40€, wird auf das Paket angerechnet). So siehst du schon früh, wie deine Website aussehen wird und ob der Stil zu dir passt.', icon: '🎨' },
        { title: 'Informationssammlung', desc: 'Nach dem Design-Entwurf brauche ich von dir: Texte, Bilder und weitere Inputs. Wichtige Fragen: Was soll der Betrachter fühlen/mitnehmen? An wen richtet sich die Seite hauptsächlich? Außerdem benötige ich die Angaben für Impressum und Datenschutz.', icon: '📦' },
    ...
    en: {
      ...
      steps: [
        ...
        { title: 'Design Draft', desc: 'I create a first design draft for you (40€, credited towards the package). This way you can see early on how your website will look and if the style fits you.', icon: '🎨' },
        { title: 'Information Gathering', desc: 'After the design draft, I need from you: texts, images, and further inputs. Important questions: What should the viewer feel/take away? Who is the site mainly aimed at? I also need the information for the imprint and privacy policy.', icon: '📦' },
